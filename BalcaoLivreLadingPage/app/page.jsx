...
import { checkoutFunctionUrl, sellers } from "./siteLinks";
...
const plans = [
  {
    ...
    price: "R$ 49,90",
    period: "/mês",
    href: `${checkoutFunctionUrl}?plan=basico-mensal`,
    features: ["PDV e vendas", "Salão, mesas e comandas", "Produtos e clientes", "Caixa e relatórios básicos", "1 computador e 1 smartphone", "Sem maquininha inclusa"]
  },
  {
    name: "Balcão Livre Essencial",
    badge: "Anual",
    ...
    price: "R$ 598,80",
    period: "/ano",
    href: `${checkoutFunctionUrl}?plan=basico-anual`,
    features: ["Tudo do Essencial mensal", "Mercado Pago Point", "Maquininha inclusa", "Endereço de entrega no pagamento", "1 computador e 1 smartphone", "Suporte online"]
  },
  {
    ...
    features: ["Tudo do Essencial", "Balcão e delivery", "Cardápio digital e WhatsApp", "iFood, garçom e cozinha", "Estoque e relatórios avançados", "Mercado Pago Point"]
  },
  {
    name: "Balcão Livre Completo",
    badge: "Anual",
    tone: "blue",
    chips: ["Completo", "Point", "Maquininha"],
    price: "R$ 1.198,80",
    period: "/ano",
    href: `${checkoutFunctionUrl}?plan=completo-anual`,
    featured: true,
    features: ["Todos os módulos do Completo", "Maquininha inclusa", "Endereço de entrega no pagamento", "1 computador e 1 smartphone", "Relatórios avançados", "Suporte prioritário"]
  }
];
...
const faqs = [
  ...
  ["Preciso digitar uma chave para ativar?", "Não. Depois do pagamento, você escolhe Windows ou Web e a ativação acontece por um acesso temporário e seguro."],
...
export default function Page({ searchParams }) {
  const activationToken =
    searchParams?.activate === "windows" ? searchParams?.handoff : "";
  const checkoutSessionId = searchParams?.checkout === "sucesso" ? searchParams?.session_id : "";

  if (activationToken) {
    return <ActivationInvite token={activationToken} />;
  }

  if (checkoutSessionId) {
    const previewPayment =
      checkoutSessionId === "preview"
      && process.env.BVPDV_PAYMENT_PREVIEW === "1";
    return <PaymentSuccess sessionId={checkoutSessionId} preview={previewPayment} />;
  }
    ...
    <main className="lpReferenceLanding">
      ...
      <section className="lpHero">
        <div className="lpHeroCopy">
          ...
          <div className="lpHeroActions">
            <a className="lpSolidButton lpGreenButton" href="#planos">
              Conhecer planos
            </a>
      ...
      <section className="lpPricing" id="planos">
        <div className="lpSectionHead lpCenter">
          ...
          <p>Escolha a cobertura ideal. Cada plano inclui 1 computador e 1 smartphone.</p>
        </div>
        ...
        <div className="lpPlanBenefits">
          <span>Caixa adicional por R$ 39,90/mês</span>
          <span>Ativação Web ou Windows</span>
          <span>1 smartphone incluso</span>
      ...
      <section className="lpBottomGrid" id="depoimentos">
        ...
        <aside className="lpFinalCta" id="contato">
          ...
          <p>Escolha o plano ideal, pague com segurança e comece no Windows ou na Web sem digitar chave.</p>
          <a className="lpSolidButton lpGreenButton" href="#planos">Escolher meu plano</a>
          <a className="lpGhostButton lpWhatsButton" href={whatsappHref}>
            <span><WhatsAppLogo /></span>
            Falar via WhatsApp
          </a>

...
const windowsDownloadHref =
  "https://github.com/lucascelopes/balcaolivre/releases/download/agenda-livre-v1.0.0/agenda-livre-windows-1.0.0.zip";
...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Crie sua conta e use o sistema por 7 dias para validar sua rotina. A mesma conta pode ser aberta na Web e no Windows, com seus dados sincronizados."
  },
  {
  ...
  },
  {
    ...
    answer:
      "Sim. Entre com a mesma conta no Windows ou na Web para acessar clientes, serviços, profissionais, agenda e financeiro. Cada aplicativo também mantém uma cópia local para continuar protegendo seu trabalho."
  },
  {
    question: "Posso levar meus dados do Windows para a Web?",
    answer:
      "Sim. Basta entrar com a mesma conta. O Agenda Livre baixa a agenda da nuvem e continua sincronizando as alterações feitas no Windows e na Web."
  }
];
      ...
      <section className={styles.trialSection} id="teste">
        <div className={styles.container}>
          ...
          <div className={styles.trialGrid}>
            <article className={`${styles.trialCard} ${styles.trialFeatured}`}>
              ...
              <ul>
                ...
                <li>
                  <Check size={15} aria-hidden="true" /> Mesma conta no Windows e na Web
                </li>
              </ul>
              <a
                className={styles.primaryButton}
            ...
            <article className={`${styles.trialCard} ${styles.trialWindows}`}>
              ...
              <p>
                Baixe a versão para computador, entre com a mesma conta da Web e use os mesmos
                dados durante o seu teste grátis de 7 dias.
              </p>
              <a
                className={styles.primaryButton}
                href={windowsDownloadHref}
                download
                data-analytics-action="agenda_windows_download"
              ...
              <small className={styles.trialMeta}>
                Pacote completo para Windows. Descompacte e abra; não precisa instalar o .NET.
              </small>
              <a
          ...
          <p className={styles.trialFootnote}>
            Seus dados ficam vinculados à sua conta e sincronizam entre Windows e Web. Em caso de
            internet instável, cada aplicativo preserva sua cópia local.
          </p>
        </div>
      </section>
            ...
            <div className={styles.reportsCopy}>
              ...
              <ul className={styles.statementList}>
                ...
                <li>
                  ...
                  <div>
                    <strong>Uma conta, qualquer plataforma</strong>
                    <p>Comece no Windows e continue na Web com a mesma agenda.</p>
                  </div>
                </li>
                <li>
                  <span>
      ...
      <section className={styles.finalCta}>
        <div className={styles.container}>
          <div className={styles.finalCtaCard}>
            ...
            <small>Sem cartão e sem compromisso. Sua conta funciona no Windows e na Web.</small>
          </div>
        </div>
      </section>

...
class FinanceDesktopLegacyDashboard extends StatefulWidget {
  const FinanceDesktopLegacyDashboard({
    super.key,
  ...
  @override
  State<FinanceDesktopLegacyDashboard> createState() =>
      _FinanceDesktopLegacyDashboardState();
}

class _FinanceDesktopLegacyDashboardState
    extends State<FinanceDesktopLegacyDashboard> {
